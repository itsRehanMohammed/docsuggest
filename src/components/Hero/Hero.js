...
const Hero = () => {
  return (
    <>
      <section className="text-gray-600 body-font bg-gradient-to-b from-white to-blue-200">
        <div className="container mx-auto flex flex-col mb-6 px-5 pt-24 pb-6 justify-center items-center">
          <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Search for best doctors near you</h1>
